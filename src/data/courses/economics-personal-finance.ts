...
const unit18Lessons: Lesson[] = [
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l1-video-1',
        type: 'video',
        title: 'What is risk and how to manage it?',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l1-article',
        type: 'article',
        title: 'Learn: What is risk and how to manage it?',
        content: `# What is risk and how to manage it?

## Types of financial risks

**Financial risk**: Possibility of losing money or not achieving financial goals.

**Types**:
- **Income risk**: Loss of income (job loss, disability)
- **Liability risk**: Being sued or responsible for damages
- **Property risk**: Damage or loss of property
- **Health risk**: Medical expenses
- **Longevity risk**: Outliving savings
- **Investment risk**: Loss of investment value

**Key insight**: Multiple types of financial risks can affect your finances.

## Ways to manage financial risk

**Risk management strategies**:
1. **Avoid**: Don't take the risk
2. **Reduce**: Minimize the risk
3. **Transfer**: Insurance (shift risk to insurer)
4. **Accept**: Take the risk yourself
...
**Key insight**: Multiple strategies available to manage financial risks.
...
**Key insight**: Risk management helps protect against financial losses.
...
**Key insight**: Effective risk management requires ongoing attention.`,
        importantPoints: [
          'Financial risk: possibility of losing money',
          'Types: income, liability, property, health, longevity, investment',
          'Strategies: avoid, reduce, transfer, accept',
          'Tools: insurance, emergency fund, diversification',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l1-practice',
        type: 'practice',
        title: 'Practice: Risk',
        exercises: [
          {
            id: 'practice-18-1-1',
            prompt: 'What are the different types of financial risks?',
            hints: [
              'Income, liability',
              'Property, health',
          ...
          {
            id: 'practice-18-1-2',
            prompt: 'What are ways to manage financial risk?',
            hints: [
              'Avoid, reduce',
              'Transfer (insurance)',
              'Accept',
          ...
          {
            id: 'practice-18-1-3',
            prompt: 'What is risk management? What are the steps?',
            hints: [
              'Process of managing risks',
              'Identify, assess, choose strategy',
              'Implement, monitor',
            ],
          },
          {
            id: 'practice-18-1-4',
            prompt: 'What tools can you use to manage risk?',
            hints: [
              'Insurance',
              'Emergency fund',
              'Diversification, safety measures',
            ],
          },
        ],
      } as PracticeContent,
      {
        id: 'economics-u18-l1-quiz',
        type: 'quiz',
        title: 'Quiz: What is risk and how to manage it?',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l2-video-1',
        type: 'video',
        title: 'Insurance basics and terminology',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l2-article',
        type: 'article',
        title: 'Learn: Insurance basics and terminology',
        content: `# Insurance basics and terminology

## How insurance works

**Insurance**: Contract that transfers risk from you to insurance company.

**How it works**:
- You pay premium (regular payment)
- Insurance company agrees to pay for covered losses
- Pool of premiums covers claims
- Spreads risk among many people

**Key insight**: Insurance transfers financial risk to insurance company.
...
- **Coverage**: What insurance protects
- **Policy**: Insurance contract
- **Claim**: Request for payment from insurance
- **Beneficiary**: Person who receives benefits
- **Policyholder**: Person who owns policy
- **Coverage limit**: Maximum amount insurance will pay

**Key insight**: Understanding terms helps choose right insurance.

## Introduction to insurance

**Purpose**: Protect against financial losses.
...
**Key insight**: Insurance is essential financial protection tool.`,
        importantPoints: [
          'Insurance: transfers risk to company',
      ...
      {
        id: 'economics-u18-l2-practice',
        type: 'practice',
        title: 'Practice: Insurance basics',
        exercises: [
          {
            id: 'practice-18-2-1',
            prompt: 'How does insurance work?',
            hints: [
              'Transfer risk to company',
              'Pay premium',
              'Company pays for covered losses',
            ],
          },
          {
            id: 'practice-18-2-2',
            prompt: 'What are key insurance terms? Explain each.',
            hints: [
              'Premium, deductible',
              'Coverage, policy',
              'Claim, beneficiary',
          ...
          {
            id: 'practice-18-2-3',
            prompt: 'What is the difference between premium and deductible?',
            hints: [
          ...
          {
            id: 'practice-18-2-4',
            prompt: 'Why is insurance important?',
            hints: [
              'Financial protection',
              'Peace of mind',
              'Protects assets',
      ...
      {
        id: 'economics-u18-l2-quiz',
        type: 'quiz',
        title: 'Quiz: Insurance basics and terminology',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l3-video-1',
        type: 'video',
        title: 'Car insurance',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l3-article',
        type: 'article',
        title: 'Learn: Car insurance',
        content: `# Car insurance

## Car insurance basics

**Car insurance**: Protects against financial losses from car accidents and other incidents.
...
- **Uninsured/Underinsured**: Covers you if other driver has no/insufficient insurance
- **Medical payments**: Covers medical expenses
- **Personal injury protection (PIP)**: Covers medical and lost wages

**Key insight**: Different coverages protect against different risks.

## What is car insurance and why do you need it?

**Why needed**:
- **Legal requirement**: Most states require liability insurance
- **Financial protection**: Covers expensive damages
- **Protects assets**: Without it, you pay out of pocket
- **Peace of mind**: Reduces worry

**What it covers**:
- Damage to other vehicles
- Medical expenses
- Property damage
- Your vehicle (if you have collision/comprehensive)

**Key insight**: Car insurance is required and provides essential protection.`,
        importantPoints: [
          'Car insurance: protects against losses',
          'Types: liability, collision, comprehensive',
          'Liability required by law',
          'Financial protection',
          'Covers damages and medical expenses',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l3-practice',
        type: 'practice',
        title: 'Practice: Car insurance',
        exercises: [
          {
            id: 'practice-18-3-1',
            prompt: 'What is car insurance? What types of coverage are there?',
            hints: [
          ...
          {
            id: 'practice-18-3-2',
            prompt: 'Why do you need car insurance?',
            hints: [
              'Legal requirement',
              'Financial protection',
              'Protects assets',
          ...
          {
            id: 'practice-18-3-3',
            prompt: 'What is the difference between liability, collision, and comprehensive coverage?',
            hints: [
          ...
          {
            id: 'practice-18-3-4',
            prompt: 'What does car insurance cover?',
            hints: [
              'Damage to vehicles',
              'Medical expenses',
              'Property damage',
      ...
      {
        id: 'economics-u18-l3-quiz',
        type: 'quiz',
        title: 'Quiz: Car insurance',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l4-video-1',
        type: 'video',
        title: 'Health insurance',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l4-article',
        type: 'article',
        title: 'Learn: Health insurance',
...
2. **PPO (Preferred Provider Organization)**:
   - More flexibility
   - Can see out-of-network (higher cost)
   - No referrals needed
   - Higher premiums

3. **EPO (Exclusive Provider Organization)**:
   - Network only (no out-of-network)
   - No referrals needed
   - Lower cost than PPO
...
4. **POS (Point of Service)**:
   ...
   - Can go out-of-network (higher cost)

**Key insight**: Different plans offer different flexibility and costs.
...
- Out-of-pocket maximum: Maximum you pay per year

**Key insight**: Health insurance is essential for financial protection.`,
        importantPoints: [
          'Types: HMO, PPO, EPO, POS',
          'HMO: lower cost, network only',
          'PPO: more flexibility, higher cost',
          'Components: premium, deductible, copay, coinsurance',
          'Essential for financial protection',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l4-practice',
        type: 'practice',
        title: 'Practice: Health insurance plans',
        exercises: [
          {
            id: 'practice-18-4-1',
            prompt: 'What are the different types of health insurance plans?',
            hints: [
              'HMO, PPO',
              'EPO, POS',
          ...
          {
            id: 'practice-18-4-2',
            prompt: 'What is the difference between HMO and PPO?',
            hints: [
              'HMO: network only, lower cost',
              'PPO: more flexibility, higher cost',
          ...
          {
            id: 'practice-18-4-3',
            prompt: 'What are key components of health insurance?',
            hints: [
              'Premium, deductible',
              'Copay, coinsurance',
          ...
          {
            id: 'practice-18-4-4',
            prompt: 'Why is health insurance important?',
            hints: [
              'High medical costs',
              'Financial protection',
              'Required by law',
      ...
      {
        id: 'economics-u18-l4-quiz',
        type: 'quiz',
        title: 'Quiz: Health insurance',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l5-video-1',
        type: 'video',
        title: 'Life insurance',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l5-article',
        type: 'article',
...
**Life insurance**: Pays benefit to beneficiaries when you die.
...
**Types**:
- **Term life**: Coverage for specific period (lower cost)
- **Whole life**: Permanent coverage with cash value (higher cost)
- **Universal life**: Flexible permanent coverage

**Key insight**: Life insurance provides financial protection for your loved ones.

## Cost and benefits of life insurance

**Cost factors**:
- Age (younger = cheaper)
- Health (better = cheaper)
- Coverage amount (more = more expensive)
- Type (term vs. permanent)
- Lifestyle (smoking, risky activities)

**Benefits**:
- Financial security for family
- Peace of mind
- Can build cash value (permanent)
- Tax advantages

**Key insight**: Life insurance cost depends on multiple factors.`,
        importantPoints: [
          'Life insurance: pays benefit when you die',
          'Types: term, whole, universal',
          'Purpose: replace income, pay debts',
          'Cost: age, health, coverage amount',
          'Benefits: financial security, peace of mind',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l5-practice',
        type: 'practice',
        title: 'Practice: Life insurance policies',
        exercises: [
          {
            id: 'practice-18-5-1',
            prompt: 'What is life insurance? What is its purpose?',
            hints: [
              'Pays benefit when you die',
              'Replace income',
              'Provide for dependents',
            ],
          },
          {
            id: 'practice-18-5-2',
            prompt: 'What are the different types of life insurance?',
            hints: [
              'Term life',
              'Whole life',
              'Universal life',
          ...
          {
            id: 'practice-18-5-3',
            prompt: 'What factors affect the cost of life insurance?',
            hints: [
              'Age, health',
              'Coverage amount',
              'Type, lifestyle',
          ...
          {
            id: 'practice-18-5-4',
            prompt: 'What are the benefits of life insurance?',
            hints: [
              'Financial security',
              'Peace of mind',
  ...
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l6-video-1',
        type: 'video',
        title: 'Property insurance',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l6-article',
        type: 'article',
        title: 'Learn: Property insurance',
...
**Types**:
- **Homeowners insurance**: Protects home and belongings
- **Renters insurance**: Protects belongings (not structure)
- **Flood insurance**: Separate coverage for floods
- **Earthquake insurance**: Separate coverage for earthquakes

**What it covers**:
- Structure (homeowners)
- Personal belongings
- Liability (if someone injured on property)
- Additional living expenses (if home uninhabitable)

**Key insight**: Property insurance protects your home and belongings.
...
**Deductibles**: Amount you pay before insurance pays.

**Coverage limits**: Maximum amount insurance will pay.

**Key insight**: Understanding coverage helps choose right policy.
...
- Know exclusions
- Keep inventory of belongings

**Key insight**: Understanding policy details ensures proper coverage.`,
        importantPoints: [
          'Property insurance: protects home and belongings',
          'Types: homeowners, renters, flood, earthquake',
          'Covers: structure, belongings, liability',
          'Features: deductibles, coverage limits',
          'Review policy carefully',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l6-practice',
        type: 'practice',
        title: 'Practice: Property insurance policies',
        exercises: [
          {
            id: 'practice-18-6-1',
            prompt: 'What is property insurance? What types are there?',
            hints: [
              'Protects property',
              'Homeowners, renters',
              'Flood, earthquake',
          ...
          {
            id: 'practice-18-6-2',
            prompt: 'What does property insurance cover?',
            hints: [
              'Structure, belongings',
              'Liability',
          ...
          {
            id: 'practice-18-6-3',
            prompt: 'What are key features of property insurance?',
            hints: [
              'Coverage types',
              'Deductibles',
              'Coverage limits',
          ...
          {
            id: 'practice-18-6-4',
            prompt: 'What should you know about property insurance policies?',
            hints: [
              'Review carefully',
              'Understand coverage',
              'Know exclusions',
      ...
      {
        id: 'economics-u18-l6-quiz',
        type: 'quiz',
        title: 'Quiz: Property insurance',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u18-l7-video-1',
        type: 'video',
        title: 'Estate planning',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u18-l7-article',
        type: 'article',
        title: 'Learn: Estate planning',
        content: `# Estate planning

## Estate planning introduction

**Estate planning**: Process of arranging for management and disposal of assets after death.
...
**Key insight**: Estate planning ensures your wishes are carried out.

## What is estate planning and why is it important?

**Why important**:
- **Control**: Decide who gets what
- **Protect family**: Provide for dependents
- **Minimize taxes**: Reduce estate taxes
- **Avoid probate**: Faster, cheaper transfer
- **Peace of mind**: Know affairs are in order
...
**Key insight**: Estate planning is important for everyone, not just wealthy.

## What are guardianship of minor children, wills, and beneficiary designation and why are they important for estate planning?

**Guardianship of minor children**: 
- Designate who cares for children if you die
- Ensures children are cared for
- Avoids court decisions
- Critical for parents

**Wills**: 
- Legal document stating who gets assets
- Names executor (manages estate)
- Can name guardian for children
- Without will, state decides (intestate)

**Beneficiary designation**: 
- Names who receives specific assets (insurance, retirement accounts)
- Overrides will for those assets
- Must be kept current
- Important for all accounts

**Key insight**: These are essential components of estate planning.`,
        importantPoints: [
          'Estate planning: arrange for asset management after death',
          'Purpose: control, protect family, minimize taxes',
          'Components: will, trusts, beneficiary designations',
          'Guardianship: who cares for children',
          'Wills: who gets assets',
          'Beneficiary designation: who receives specific assets',
        ],
      } as ArticleContent,
      {
        id: 'economics-u18-l7-practice',
        type: 'practice',
        title: 'Practice: Estate planning',
        exercises: [
          {
            id: 'practice-18-7-1',
            prompt: 'What is estate planning? Why is it important?',
            hints: [
              'Arrange for asset management',
              'Control who gets what',
              'Protect family, minimize taxes',
            ],
          },
          {
            id: 'practice-18-7-2',
            prompt: 'What is a will? Why is it important?',
            hints: [
              'Legal document',
              'States who gets assets',
              'Without it, state decides',
            ],
          },
          {
            id: 'practice-18-7-3',
            prompt: 'What is guardianship of minor children? Why is it important?',
            hints: [
              'Designate who cares for children',
              'Ensures children are cared for',
              'Avoids court decisions',
            ],
          },
          {
            id: 'practice-18-7-4',
            prompt: 'What is beneficiary designation? Why is it important?',
            hints: [
              'Names who receives assets',
              'Overrides will for those assets',
              'Must be kept current',
            ],
          },
      ...
      {
        id: 'economics-u18-l7-quiz',
        type: 'quiz',
        title: 'Quiz: Estate planning',
        questions: [],
      } as QuizContent,
    ],
  },
...
const unit19Lessons: Lesson[] = [
  {
    ...
    contentItems: [
      {
        id: 'economics-u19-l1-video-1',
        type: 'video',
        title: 'Owning vs leasing',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u19-l1-article',
        type: 'article',
        title: 'Learn: Owning vs leasing',
        content: `# Owning vs leasing
...
- **Can customize**: Modify as you wish
- **Build equity**: Car has value when paid off
- **Higher monthly payments**: Usually
- **Long-term cost**: Lower if you keep car long time

**Leasing**:
- **No ownership**: Return car at end
- **Mileage limits**: Usually 10,000-15,000 miles/year
- **Can't customize**: Must return in good condition
- **No equity**: No asset at end
- **Lower monthly payments**: Usually
- **Always have payment**: Must lease or buy again

**Key insight**: Buying gives ownership; leasing gives lower payments but no ownership.

## When leasing might come out better than buying

**Leasing may be better if**:
- Want new car every 2-3 years
- Drive less than mileage limit
- Don't want to own
- Business use (tax benefits)
- Lower monthly payment needed
- Don't want maintenance of older car

**Key insight**: Leasing can make sense for specific situations.

## Making the decision: lease or buy

**Considerations**:
- How long will you keep car?
...
**Key insight**: Decision depends on your situation and preferences.`,
        importantPoints: [
          'Buying: ownership, no mileage limits, build equity',
          'Leasing: no ownership, mileage limits, lower payments',
          'Leasing better: want new car often, low mileage',
          'Consider: length of ownership, mileage, budget',
        ],
      } as ArticleContent,
      {
        id: 'economics-u19-l1-practice',
        type: 'practice',
        title: 'Practice: Pros and cons of lease vs buy',
        exercises: [
          {
            id: 'practice-19-1-1',
            prompt: 'What are the differences between buying and leasing a car?',
            hints: [
              'Buying: ownership, no mileage limits',
              'Leasing: no ownership, mileage limits',
              'Different costs and benefits',
            ],
          },
          {
            id: 'practice-19-1-2',
            prompt: 'When might leasing be better than buying?',
            hints: [
              'Want new car often',
              'Low mileage',
          ...
          {
            id: 'practice-19-1-3',
            prompt: 'What factors should you consider when deciding to lease or buy?',
            hints: [
              'How long keep car',
              'How much drive',
              'Budget, preferences',
          ...
          {
            id: 'practice-19-1-4',
            prompt: 'What are the pros and cons of each option?',
            hints: [
              'Buying: ownership, equity',
      ...
      {
        id: 'economics-u19-l1-quiz',
        type: 'quiz',
        title: 'Quiz: Owning vs leasing',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u19-l2-video-1',
        type: 'video',
        title: 'Car loans',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u19-l2-article',
        type: 'article',
        title: 'Learn: Car loans',
        content: `# Car loans
...
**Key insight**: Payment depends on loan amount, rate, and term.
...
**Lower payment strategies**:
- Larger down payment
- Longer loan term
- Lower interest rate
- Less expensive car

**Key insight**: Multiple ways to reduce monthly payment.

## Monthly payment versus total cost

**Monthly payment**: Amount paid each month.

**Total cost**: Total amount paid over loan term.

**Important**:
- Lower payment ≠ Lower total cost
- Longer term = More interest = Higher total cost
- Focus on total cost, not just payment

**Example**:
- $20,000 at 5% for 36 months: $599/month, $21,564 total
- $20,000 at 5% for 60 months: $377/month, $22,620 total
- Lower payment but $1,056 more total!

**Key insight**: Longer terms reduce payment but increase total cost.

## Monthly payment vs price

**Price**: What car costs.

**Payment**: Monthly amount.

**Relationship**:
- Higher price = Higher payment (if same terms)
- But: Terms affect payment more than price
- Can have same payment for different prices (different terms)

**Key insight**: Don't focus only on payment - consider total price and cost.`,
        importantPoints: [
          'Payment: depends on loan amount, rate, term',
          'Lower payment ≠ lower total cost',
      ...
      {
        id: 'economics-u19-l2-practice',
        type: 'practice',
        title: 'Practice: Financing a car',
        exercises: [
          {
            id: 'practice-19-2-1',
            prompt: 'What factors affect car loan payment?',
            hints: [
              'Loan amount',
              'Interest rate',
              'Loan term',
          ...
          {
            id: 'practice-19-2-2',
            prompt: 'What is the difference between monthly payment and total cost?',
            hints: [
              'Payment: monthly amount',
              'Total cost: total paid over term',
              'Lower payment ≠ lower cost',
            ],
          },
          {
            id: 'practice-19-2-3',
            prompt: 'How does loan term affect payment and total cost?',
            hints: [
          ...
          {
            id: 'practice-19-2-4',
            prompt: 'Why should you focus on total cost, not just monthly payment?',
            hints: [
              'Lower payment can mean higher cost',
              'Total cost shows true expense',
              'Avoid paying more over time',
            ],
          },
        ],
      } as PracticeContent,
      {
        id: 'economics-u19-l2-quiz',
        type: 'quiz',
        title: 'Quiz: Car loans',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u19-l3-video-1',
        type: 'video',
        title: 'Cost of car ownership',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u19-l3-article',
        type: 'article',
        title: 'Learn: Cost of car ownership',
        content: `# Cost of car ownership

## The real cost of owning a car

**Total cost includes**:
- **Purchase price**: What you pay for car
- **Financing costs**: Interest on loan
...
**Key insight**: Car payment is just one cost - many others add up.

## Beyond the car payment

**Additional costs**:
- **Insurance**: $100-300/month (varies)
- **Fuel**: $100-300/month (varies by driving)
- **Maintenance**: $50-150/month (average)
- **Repairs**: Variable, increases with age
- **Registration/tags**: $50-200/year
- **Parking**: $0-300/month (if applicable)
- **Tolls**: Variable

**Total monthly cost**: Payment + All other costs.

**Key insight**: True cost is much more than just the payment.

## What are the true costs of car ownership?

**Annual costs** (example):
- Payment: $4,500/year ($375/month)
- Insurance: $1,800/year ($150/month)
- Fuel: $1,800/year ($150/month)
- Maintenance: $1,200/year ($100/month)
- Registration: $100/year
- **Total**: ~$9,400/year (~$783/month)

**Over 5 years**: ~$47,000 (not including depreciation).

**Key insight**: True cost of ownership is significantly more than payment alone.`,
        importantPoints: [
          'Total cost: payment + insurance + fuel + maintenance',
          'Many costs beyond payment',
          'Insurance, fuel, maintenance add up',
          'True cost much higher than payment',
          'Consider all costs when budgeting',
        ],
      } as ArticleContent,
      {
        id: 'economics-u19-l3-practice',
        type: 'practice',
        title: 'Practice: Additional costs of car ownership',
        exercises: [
          {
            id: 'practice-19-3-1',
            prompt: 'What are the real costs of owning a car?',
            hints: [
          ...
          {
            id: 'practice-19-3-2',
            prompt: 'What costs are there beyond the car payment?',
            hints: [
              'Insurance',
              'Fuel, maintenance',
          ...
          {
            id: 'practice-19-3-3',
            prompt: 'Why is it important to consider all costs, not just the payment?',
            hints: [
              'True cost much higher',
              'All costs add up',
              'Need accurate budget',
            ],
          },
          {
            id: 'practice-19-3-4',
            prompt: 'How do you calculate the true cost of car ownership?',
            hints: [
              'Add all costs',
              'Payment + insurance + fuel',
              'Maintenance + registration + other',
            ],
          },
        ],
      } as PracticeContent,
      {
        id: 'economics-u19-l3-practice-2',
        type: 'practice',
        title: 'Practice: Monthly car costs',
        exercises: [
          {
            id: 'practice-19-3-5',
            prompt: 'What are typical monthly car costs?',
            hints: [
              'Payment',
              'Insurance, fuel',
              'Maintenance',
          ...
          {
            id: 'practice-19-3-6',
            prompt: 'How much should you budget for car ownership?',
            hints: [
              'Consider all costs',
          ...
          {
            id: 'practice-19-3-7',
            prompt: 'What factors affect total car ownership costs?',
            hints: [
              'Type of car',
              'How much you drive',
              'Age of car, location',
          ...
          {
            id: 'practice-19-3-8',
            prompt: 'How can you reduce car ownership costs?',
            hints: [
      ...
      {
        id: 'economics-u19-l3-quiz',
        type: 'quiz',
        title: 'Quiz: Cost of car ownership',
        questions: [],
      } as QuizContent,
    ],
  },
...
const unit20Lessons: Lesson[] = [
  {
    ...
    contentItems: [
      {
        id: 'economics-u20-l1-video-1',
        type: 'video',
        title: 'Renting vs homeownership',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u20-l1-article',
        type: 'article',
        title: 'Learn: Renting vs homeownership',
        content: `# Renting vs homeownership
...
- **Rent increases**: Can go up
- **Lower upfront cost**: Security deposit
- **No tax benefits**: Can't deduct rent

**Buying**:
- **Ownership**: Build equity
- **Stable payments**: Fixed mortgage (if fixed rate)
- **Maintenance**: Your responsibility
- **Tax benefits**: Mortgage interest deduction
- **Higher upfront cost**: Down payment, closing costs
- **Less flexible**: Harder to move

**Key insight**: Renting offers flexibility; buying offers ownership and equity.

## Advantages and disadvantages of owning vs renting

**Owning advantages**:
- Build equity
- Stable payments (fixed mortgage)
- Tax benefits
- Freedom to modify
...
**Key insight**: Each option has tradeoffs - choose based on your situation.
...
- **Renter's insurance**: Usually required
...
**Key insight**: Renting has upfront and ongoing costs beyond just rent.

## Requirements for renting or buying a home

**Renting requirements**:
- Income (usually 3x rent)
- Credit check
- Background check
- References
- Application
...
**Key insight**: Both require financial qualifications.

## Things to consider when renting a home

**Considerations**:
- **Location**: Neighborhood, commute
- **Cost**: Rent, utilities, fees
- **Size**: Bedrooms, square footage
- **Amenities**: Parking, laundry, storage
- **Lease terms**: Length, renewal, penalties
- **Condition**: Inspect before signing
- **Landlord**: Responsiveness, reputation
- **Rules**: Pets, modifications, guests

**Key insight**: Research thoroughly before renting.

## Renting requirements

**Typical requirements**:
- **Income**: 2.5-3x monthly rent
- **Credit score**: Usually 600+ (varies)
- **Employment**: Stable job
- **References**: Previous landlords
- **Background check**: Criminal history
- **Security deposit**: 1-2 months rent

**Key insight**: Landlords verify ability to pay rent.
...
- **Condition**: Inspection, repairs needed
- **Market**: Prices, trends
- **Future plans**: How long will you stay?
- **Total cost**: Down payment, closing, ongoing
- **Mortgage**: Rate, term, type
- **Maintenance**: Ongoing costs

**Key insight**: Buying is major decision - consider carefully.

## Buying requirements

**Typical requirements**:
- **Down payment**: 3-20% of purchase price
- **Credit score**: Usually 620+ (varies by loan)
...
**Key insight**: Lenders verify ability to repay mortgage.`,
        importantPoints: [
          'Renting: flexibility, no maintenance, no equity',
          'Buying: ownership, equity, tax benefits, maintenance',
          'True cost: rent + deposit + fees + utilities',
          'Requirements: income, credit, employment',
          'Consider: location, cost, condition, future plans',
        ],
      } as ArticleContent,
      {
        id: 'economics-u20-l1-practice',
        type: 'practice',
        title: 'Practice: Owning vs renting',
        exercises: [
          {
            id: 'practice-20-1-1',
            prompt: 'What are the differences between renting and buying a home?',
            hints: [
          ...
          {
            id: 'practice-20-1-2',
            prompt: 'What are the advantages and disadvantages of owning vs renting?',
            hints: [
              'Owning: equity, tax benefits, maintenance',
              'Renting: flexibility, no maintenance, no equity',
              'Tradeoffs',
            ],
          },
          {
            id: 'practice-20-1-3',
            prompt: 'When might renting be better than buying?',
            hints: [
              'Short-term stay',
              'Want flexibility',
          ...
          {
            id: 'practice-20-1-4',
            prompt: 'When might buying be better than renting?',
            hints: [
              'Long-term stay',
      ...
      {
        id: 'economics-u20-l1-practice-2',
        type: 'practice',
        title: 'Practice: Housing costs',
        exercises: [
          {
            id: 'practice-20-1-5',
            prompt: 'What are the true costs of renting?',
            hints: [
              'Monthly rent',
          ...
          {
            id: 'practice-20-1-6',
            prompt: 'What are the true costs of buying?',
            hints: [
          ...
          {
            id: 'practice-20-1-7',
            prompt: 'How do you calculate total housing costs?',
            hints: [
              'Add all costs',
          ...
          {
            id: 'practice-20-1-8',
            prompt: 'What hidden costs should you consider?',
            hints: [
              'Utilities',
              'Maintenance, repairs',
      ...
      {
        id: 'economics-u20-l1-practice-3',
        type: 'practice',
        title: 'Practice: Requirements for renting and buying a home',
        exercises: [
          {
            id: 'practice-20-1-9',
            prompt: 'What are the requirements for renting a home?',
            hints: [
              'Income (3x rent)',
              'Credit check',
              'References, deposit',
          ...
          {
            id: 'practice-20-1-10',
            prompt: 'What are the requirements for buying a home?',
            hints: [
              'Down payment',
              'Credit score, income',
              'Debt-to-income ratio',
          ...
          {
            id: 'practice-20-1-11',
            prompt: 'What should you consider when renting?',
            hints: [
              'Location, cost',
              'Lease terms',
              'Condition, landlord',
          ...
          {
            id: 'practice-20-1-12',
            prompt: 'What should you know before buying?',
            hints: [
              'Affordability',
              'Location, condition',
              'Market, future plans',
      ...
      {
        id: 'economics-u20-l1-quiz',
        type: 'quiz',
        title: 'Quiz: Renting vs homeownership',
        questions: [],
      } as QuizContent,
    ],
  },
...
const unit21Lessons: Lesson[] = [
  {
    ...
    contentItems: [
      {
        id: 'economics-u21-l1-video-1',
        type: 'video',
        title: 'Personal information and identity',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u21-l1-article',
        type: 'article',
        title: 'Learn: Personal information and identity',
        content: `# Personal information and identity

## (PII) Personally Identifiable Information

**Personally Identifiable Information (PII)**:
- Information that can identify you
- Can be used alone or with other information
- Must be protected
...
- **Medical**: Health records, insurance numbers
...
- Laws protect PII
- Companies must secure it

**Key insight**: PII is sensitive information that can identify you - protect it carefully.
...
- To commit fraud or crimes

**How it happens**:
- **Data breaches**: Companies hacked
- **Phishing**: Fake emails/websites
- **Theft**: Physical documents stolen
- **Dumpster diving**: Trash searched
- **Skimming**: Card readers capture data
- **Social engineering**: Tricked into sharing
...
- Missing mail
- IRS notices about multiple returns
- Medical bills for services you didn't receive

**How to protect yourself**:
- **Shred documents**: With personal information
- **Secure mail**: Lock mailbox
- **Monitor credit**: Check reports regularly
- **Use strong passwords**: Unique, complex
- **Be cautious online**: Don't share PII
- **Check statements**: Review regularly
- **Freeze credit**: If needed

**What to do if victim**:
- **Report**: FTC, police
- **Contact companies**: Banks, credit bureaus
- **Freeze credit**: Stop new accounts
- **Monitor**: Watch for new activity
- **Document**: Keep records

**Key insight**: Identity theft is serious - protect your PII and monitor for signs.`,
        importantPoints: [
          'PII: information that can identify you',
          'Examples: SSN, name, address, financial info',
          'Identity theft: someone uses your info fraudulently',
          'Protect: shred, secure, monitor, be cautious',
          'If victim: report, freeze credit, monitor',
        ],
      } as ArticleContent,
      {
        id: 'economics-u21-l1-practice',
        type: 'practice',
        title: 'Practice: Identity theft',
        exercises: [
          {
            id: 'practice-21-1-1',
            ...
            hints: [
              'Information that can identify you',
              'Can be used alone or with other info',
              'Must be protected',
            ],
          },
          {
            id: 'practice-21-1-2',
            prompt: 'What are examples of PII?',
            hints: [
              'Social Security Number',
          ...
          {
            id: 'practice-21-1-3',
            prompt: 'What is identity theft? How does it happen?',
            hints: [
              'Someone uses your info without permission',
              'Data breaches, phishing, theft',
              'Can commit fraud or crimes',
            ],
          },
          {
            id: 'practice-21-1-4',
            prompt: 'How can you protect yourself from identity theft?',
            hints: [
              'Shred documents',
              'Monitor credit, use strong passwords',
              'Be cautious online, check statements',
            ],
          },
        ],
      } as PracticeContent,
      {
        id: 'economics-u21-l1-quiz',
        type: 'quiz',
        title: 'Quiz: Personal information and identity',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u21-l2-video-1',
        type: 'video',
        title: 'Common scams',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u21-l2-article',
        type: 'article',
...
- **Phone scams**: Fake calls asking for money/info
- **Romance scams**: Fake relationships to get money
- **Tech support scams**: Fake tech support
- **Lottery/sweepstakes**: Fake winnings
- **Grandparent scam**: Pretend to be relative in trouble
- **IRS scam**: Fake tax collection
- **Charity scams**: Fake charities
- **Investment scams**: Fake investments
- **Online shopping scams**: Fake products/sites
...
**Key insight**: Many scams exist - be aware and cautious.

## Don't get scammed: how to spot and avoid common fraud schemes

**How to spot scams**:
- **Urgency**: Pressure to act now
- **Payment methods**: Gift cards, wire transfers, cryptocurrency
- **Personal info requests**: SSN, passwords, account numbers
- **Too good to be true**: Unrealistic promises
- **Threats**: Legal action, arrest, account closure
...
**How to avoid scams**:
- **Verify**: Check with real company/person
- **Don't rush**: Take time to think
- **Don't share**: Personal or financial info
- **Research**: Look up company/person
- **Use secure payment**: Credit card, not wire transfer
- **Trust instincts**: If it feels wrong, it probably is
- **Report**: Tell authorities

**What to do if scammed**:
- **Stop contact**: Don't send more money
- **Report**: FTC, police, company
- **Contact bank**: If money sent
- **Monitor accounts**: Watch for fraud
- **Document**: Keep records

**Key insight**: Be skeptical, verify, and don't rush - most scams rely on pressure and urgency.`,
        importantPoints: [
          'Common scams: phishing, phone, romance, tech support',
          'Red flags: urgency, unusual payment, personal info requests',
          'Spot scams: pressure, threats, too good to be true',
          'Avoid: verify, don\'t rush, don\'t share info',
          'If scammed: stop, report, contact bank, monitor',
        ],
      } as ArticleContent,
      {
        id: 'economics-u21-l2-practice',
        type: 'practice',
        title: 'Practice: Scams',
        exercises: [
          {
            id: 'practice-21-2-1',
            prompt: 'What are common scams you should be aware of?',
            hints: [
          ...
          {
            id: 'practice-21-2-2',
            prompt: 'What are red flags of scams?',
            hints: [
              'Pressure to act quickly',
          ...
          {
            id: 'practice-21-2-3',
            prompt: 'How can you spot and avoid scams?',
            hints: [
          ...
          {
            id: 'practice-21-2-4',
            prompt: 'What should you do if you are scammed?',
            hints: [
              'Stop contact',
              'Report to authorities',
              'Contact bank, monitor accounts',
            ],
          },
        ],
      } as PracticeContent,
      {
        id: 'economics-u21-l2-quiz',
        type: 'quiz',
        title: 'Quiz: Common scams',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u21-l3-video-1',
        type: 'video',
        title: 'Contracts',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u21-l3-article',
        type: 'article',
        title: 'Learn: Contracts',
        content: `# Contracts
...
- **Implied**: Actions show agreement
...
- **Disputes**: How to resolve

**Key insight**: Contracts create legal obligations - understand before signing.

## Understanding contracts: What they are and why they matter

**Why contracts matter**:
- **Protect rights**: Define what each party gets
- **Clarify obligations**: What each must do
- **Prevent disputes**: Clear terms reduce confusion
- **Legal enforcement**: Can be enforced in court
- **Build trust**: Formal agreement

**What to look for**:
- **All terms**: Read everything
- **Hidden fees**: Look for extra costs
- **Cancellation policy**: How to get out
- **Warranties**: What's guaranteed
- **Dispute resolution**: How problems solved
- **Fine print**: Important details

**Before signing**:
- **Read carefully**: Don't rush
- **Ask questions**: Clarify unclear terms
- **Negotiate**: Can change terms
- **Get copy**: Keep for records
- **Understand**: Know what you're agreeing to
- **Consider**: Is it fair and reasonable?

**Common contract issues**:
- **Unclear terms**: Vague language
- **Hidden fees**: Not disclosed upfront
- **Unfair terms**: One-sided
- **Pressure**: Rushed to sign
- **Misunderstanding**: Didn't read carefully

**Key insight**: Contracts are important - read carefully, understand terms, and don't sign under pressure.`,
        importantPoints: [
          'Contract: legal agreement creating obligations',
          'Elements: offer, acceptance, consideration, capacity, legality',
          'Why matter: protect rights, clarify obligations',
          'Before signing: read, ask questions, understand',
          'Common issues: unclear terms, hidden fees, pressure',
        ],
      } as ArticleContent,
      {
        id: 'economics-u21-l3-practice',
        type: 'practice',
        title: 'Practice: Understanding contracts',
        exercises: [
          {
            id: 'practice-21-3-1',
          ...
          {
            id: 'practice-21-3-2',
            prompt: 'What are the elements of a contract?',
            hints: [
              'Offer, acceptance',
              'Consideration',
              'Capacity, legality',
          ...
          {
            id: 'practice-21-3-3',
            prompt: 'Why do contracts matter?',
            hints: [
              'Protect rights',
              'Clarify obligations',
              'Legal enforcement',
          ...
          {
            id: 'practice-21-3-4',
            prompt: 'What should you do before signing a contract?',
            hints: [
              'Read carefully',
              'Ask questions',
              'Understand terms',
      ...
      {
        id: 'economics-u21-l3-quiz',
        type: 'quiz',
        title: 'Quiz: Contracts',
        questions: [],
      } as QuizContent,
    ],
  },
  {
    ...
    contentItems: [
      {
        id: 'economics-u21-l4-video-1',
        type: 'video',
        title: 'Consumer protection agencies',
        videoIndex: 0,
      } as VideoContent,
      {
        id: 'economics-u21-l4-article',
        type: 'article',
        title: 'Learn: Consumer protection agencies',
        content: `# Consumer protection agencies

## Consumer protection 101

**Consumer protection**:
- Laws and agencies protect consumers
- From unfair or deceptive practices
- Help resolve disputes

**Why it matters**:
- **Fair treatment**: Consumers treated fairly
- **Safety**: Products/services safe
- **Truth**: Honest information
- **Recourse**: Way to resolve problems
- **Prevention**: Stops bad practices
...
- **State agencies**: State consumer protection offices

**What they do**:
- **Enforce laws**: Stop violations
- **Educate**: Inform consumers
- **Investigate**: Look into complaints
- **Mediate**: Help resolve disputes
- **Prosecute**: Take legal action

**Key insight**: Consumer protection agencies help ensure fair treatment and safety.
...
- **State agencies**: State consumer protection office
...
**Key insight**: Filing a complaint can help resolve issues and protect others from similar problems.`,
        importantPoints: [
          'Consumer protection: laws and agencies protect consumers',
          'Key agencies: FTC, CFPB, FDA, CPSC, state agencies',
          'Steps: gather info, contact company, file complaint',
          'Where to file: FTC, CFPB, state agencies, BBB',
          'Include: contact info, problem description, documents',
        ],
      } as ArticleContent,
      {
        id: 'economics-u21-l4-practice',
        type: 'practice',
        title: 'Practice: Consumer protection agencies',
        exercises: [
          {
            id: 'practice-21-4-1',
            prompt: 'What is consumer protection? Why does it matter?',
            hints: [
              'Laws and agencies protect consumers',
          ...
          {
            id: 'practice-21-4-2',
            prompt: 'What are key consumer protection agencies?',
            hints: [
              'FTC, CFPB',
              'FDA, CPSC',
              'State agencies',
          ...
          {
            id: 'practice-21-4-3',
            prompt: 'How do you file a consumer complaint?',
            hints: [
              'Gather information',
          ...
          {
            id: 'practice-21-4-4',
            prompt: 'What information should you include in a complaint?',
            hints: [
              'Contact information',
              'Problem description',
              'Supporting documents',
      ...
      {
        id: 'economics-u21-l4-quiz',
        type: 'quiz',
        title: 'Quiz: Consumer protection agencies',
        questions: [],
      } as QuizContent,
    ],
  },
...
export const economicsPersonalFinanceCourse: Course = {
  ...
  units: [
    ...
    },
    {
      ...
      description: 'Understanding risk management, insurance basics, car insurance, health insurance, life insurance, property insurance, and estate planning',
      lessons: unit18Lessons,
    },
    {
      id: 'unit-19',
      title: 'Unit 19: Car buying',
      description: 'Understanding owning vs. leasing, car loans, and the true cost of car ownership',
      lessons: unit19Lessons,
    },
    {
      id: 'unit-20',
      title: 'Unit 20: Housing',
      description: 'Understanding renting vs. homeownership, housing costs, and requirements',
      lessons: unit20Lessons,
    },
    {
      id: 'unit-21',
      title: 'Unit 21: Scams & fraud',
      description: 'Understanding personal information and identity, common scams, contracts, and consumer protection',
