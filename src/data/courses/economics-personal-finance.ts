      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation: 'In PACED decision making, when a choice is made based on the highest total score, the opportunity cost is the value of the next best alternative that was given up. If Sally chose Major A (Computer Science) with the highest score of 28, the opportunity cost would be Major B (Art History) with the second-highest score of 27. The "remaining trade-off" refers to the alternative that represents the opportunity cost of the chosen option, which is Major B (Art History).',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation: 'Investments in human capital (staff training), capital goods (new equipment), and technology (software) all contribute to increased productivity. Better-trained staff work more efficiently, new equipment can produce more output, and technology streamlines operations. While there may be initial costs and adjustment periods, these investments typically lead to long-term productivity gains.',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation: 'A partnership best matches these characteristics. Partnerships involve shared liability (partners are jointly liable), potential for conflict (multiple decision-makers), and shared profits. The benefits listed - combined skills and resources, relatively easier access to capital, and shared responsibilities - are all typical of partnerships where multiple owners contribute their expertise, capital, and share in management responsibilities.',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 0,
            explanation: 'An oligopoly is a market structure where a small number of firms have the large majority of market share. Monopolistic competition is a market structure where many firms compete with slightly differentiated products. These are the correct matches for the descriptions provided.',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 0,
            explanation: 'A change in quantity demanded refers to movement along the demand curve caused by a change in the price of the good itself. A change in demand refers to a shift of the entire demand curve caused by non-price factors such as income, tastes, prices of related goods, expectations, or number of buyers. These are distinct concepts and cannot be used interchangeably.',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation: 'The law of supply states that, all else being equal, as the price of a good increases, the quantity supplied increases. This is represented by a movement along the supply curve (upward and to the right), not a shift of the curve itself. A shift of the supply curve would be caused by non-price factors such as technology, input prices, or number of sellers.',
          },
        ],
      } as QuizContent,
    ],
      ...
      } as PracticeContent,
      {
        ...
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation: 'A surplus occurs when quantity supplied is greater than quantity demanded (QS > QD). At the equilibrium price of $12, QD = QS = 4, so there is no surplus. At prices above $12 (such as $14, $16, $18, or $20), QS > QD, creating a surplus. For example, at $14, QS = 6 and QD = 3, resulting in a surplus of 3 units.',
          },
        ],
      } as QuizContent,
    ],
